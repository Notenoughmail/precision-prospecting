...
public class CustomProsItemBuilder extends AreaHandheldItemBuilder {
    ...
    public CustomProsItemBuilder(ResourceLocation resourceLocation) {
        super(resourceLocation, 3f, -2.4f, 15, 12, 12, 0);
    }

    @Override
    public Item createObject() {
        return new ProspectorItem(toolTier, (int) attackDamageBaseline, speedBaseline, createItemProperties(), coolDownBaseline, primaryRadiusBaseline, secondaryRadiusBaseline, displacementBaseline);
    }
}
